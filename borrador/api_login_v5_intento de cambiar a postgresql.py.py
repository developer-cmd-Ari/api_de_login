...
async def read_user_profile(
    ...
    try:
        ...
        nombre_usuario_db = user_row.nombre_usuario  # o user_row[0]
        plan_id_db = user_row.plan_id            # o user_row[1]
        ...
        # --- SECCIÓN CORREGIDA ---
        # Se elimina el bloque 'if not profile_data:' que causaba el error
        # y se construye la respuesta directamente con las variables correctas.
